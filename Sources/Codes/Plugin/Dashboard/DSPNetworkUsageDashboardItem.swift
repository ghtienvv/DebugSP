...
@MainActor
public class DSPNetworkUsageDashboardItem: @preconcurrency DSPDashboardItem {
    public init() {}
    public let title: String = "Network"
    public let widgetItem: DSPOptions.Widget.Item = .networkUsage
    var lastNetworkUsage: DSPNetworkUsage? = nil
    ...
    private func updateNetworkUsage() {
        let networkUsage = DSPDevice.current.networkUsage()
