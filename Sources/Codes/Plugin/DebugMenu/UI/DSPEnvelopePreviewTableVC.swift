...
@MainActor
final class DSPEnvelopePreviewTableVC: UITableViewController {

    var envelops: [DSPEnvelope] = []
    var fetcher: () async -> [DSPEnvelope]

    init(fetcher: @escaping () async -> [DSPEnvelope]) {
