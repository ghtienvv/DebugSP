...
#import "DSPCarouselCell.h"
#import "DSPColor.h"
#import "DSPMacros.h"
#import "UIView+DSP_Layout.h"

const CGFloat kDSPScopeCarouselItemSpacing = 0;
NSString * const kDSPScopeCarouselCellReuseIdentifier = @"kCarouselCellReuseIdentifier";

@interface DSPScopeCarousel () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, readonly) UICollectionView *collectionView;
@property (nonatomic, readonly) DSPXCarouselCell *sizingCell;
...
@implementation DSPScopeCarousel

- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = DSPColor.primaryBackgroundColor;
        ...
        UICollectionViewFlowLayout *layout = ({
            ...
            layout.minimumLineSpacing = kDSPScopeCarouselItemSpacing;
        ...
        _collectionView = ({
            ...
            cv.delegate = self;
            cv.dataSource = self;
            [cv registerClass:[DSPXCarouselCell class] forCellWithReuseIdentifier:kDSPScopeCarouselCellReuseIdentifier];
        ...
        // Sizing cell
        _sizingCell = [DSPXCarouselCell new];
        ...
        _dynamicTypeObserver = [NSNotificationCenter.defaultCenter
            ...
            object:nil queue:nil usingBlock:^(NSNotification *note) { strongify(self)
                ...
                // Notify observers
                for (void (^block)(DSPScopeCarousel *) in self.dynamicTypeHandlers) {
                    block(self);
                }
            }
        ];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, DSPColor.hairlineColor.CGColor);
...
- (void)updateConstraints {
    if (!self.constraintsInstalled) {
        ...
        [self.collectionView dsp_pinEdgesToSuperview];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    DSPXCarouselCell *cell = (id)[collectionView dequeueReusableCellWithReuseIdentifier:kDSPScopeCarouselCellReuseIdentifier
