...
@protocol DSPColorComponentInputViewDelegate;

@interface DSPColorComponentInputView : UIView

@property (nonatomic) UISlider *slider;
@property (nonatomic) UILabel *valueLabel;

@property (nonatomic, weak) id <DSPColorComponentInputViewDelegate> delegate;

@end

@protocol DSPColorComponentInputViewDelegate <NSObject>

- (void)colorComponentInputViewValueDidChange:(DSPColorComponentInputView *)colorComponentInputView;

@end


@implementation DSPColorComponentInputView
...
- (void)layoutSubviews {
    ...
    CGFloat valueLabelOriginY = DSPFloor((self.slider.frame.size.height - self.valueLabel.frame.size.height) / 2.0);
...
@interface DSPColorPreviewBox : UIView
...
@implementation DSPColorPreviewBox
...
@interface DSPArgumentInputColorView () <DSPColorComponentInputViewDelegate>

@property (nonatomic) DSPColorPreviewBox *colorPreviewBox;
@property (nonatomic) UILabel *hexLabel;
@property (nonatomic) DSPColorComponentInputView *alphaInput;
@property (nonatomic) DSPColorComponentInputView *redInput;
@property (nonatomic) DSPColorComponentInputView *greenInput;
@property (nonatomic) DSPColorComponentInputView *blueInput;

@end

@implementation DSPArgumentInputColorView

- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    self = [super initWithArgumentTypeEncoding:typeEncoding];
    if (self) {
        self.colorPreviewBox = [DSPColorPreviewBox new];
        ...
        self.alphaInput = [DSPColorComponentInputView new];
        ...
        self.blueInput = [DSPColorComponentInputView new];
...
- (void)layoutSubviews {
    ...
    NSArray<DSPColorComponentInputView *> *colorComponentInputViews = @[self.alphaInput, self.redInput, self.greenInput, self.blueInput];
    for (DSPColorComponentInputView *inputView in colorComponentInputViews) {
...
+ (BOOL)supportsObjCType:(const char *)type withCurrentValue:(id)value {
    ...
    return (strcmp(type, @encode(CGColorRef)) == 0) || (strcmp(type, DSPEncodeClass(UIColor)) == 0);
}
