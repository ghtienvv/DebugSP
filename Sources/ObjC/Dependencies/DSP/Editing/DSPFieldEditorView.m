...
@implementation DSPFieldEditorView
...
- (void)setArgumentInputViews:(NSArray<DSPArgumentInputView *> *)argumentInputViews {
    if (![_argumentInputViews isEqual:argumentInputViews]) {
        
        for (DSPArgumentInputView *inputView in _argumentInputViews) {
            [inputView removeFromSuperview];
        }
        
        _argumentInputViews = argumentInputViews;
        
        for (DSPArgumentInputView *newInputView in argumentInputViews) {
...
+ (UIColor *)dividerColor {
    return DSPColor.tertiaryBackgroundColor;
}
