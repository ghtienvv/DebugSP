...
@interface DSPVariableEditorViewController : UIViewController {
    @protected
    id _target;
    _Nullable id _data;
...
@property (nonatomic, readonly, nullable) DSPArgumentInputView *firstInputView;

@property (nonatomic, readonly) DSPFieldEditorView *fieldEditorView;
