...
@interface DSPVariableEditorViewController () <UIScrollViewDelegate>
@property (nonatomic) UIScrollView *scrollView;
@end

@implementation DSPVariableEditorViewController
...
- (void)keyboardDidShow:(NSNotification *)notification {
    ...
    for (DSPArgumentInputView *argumentInputView in self.fieldEditorView.argumentInputViews) {
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = DSPColor.scrollViewBackgroundColor;
    ...
    _fieldEditorView = [DSPFieldEditorView new];
    ...
    self.toolbarItems = @[UIBarButtonItem.dsp_dspibleSpace, self.actionButton];
}
...
- (DSPArgumentInputView *)firstInputView {
...
- (void)exploreObjectOrPopViewController:(id)objectOrNil {
    if (objectOrNil) {
        ...
        DSPObjectExplorerViewController *explorerViewController = [DSPObjectExplorerFactory explorerViewControllerForObject:objectOrNil];
