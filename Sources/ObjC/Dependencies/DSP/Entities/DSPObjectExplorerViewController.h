...
#define _DSPObjectExplorerViewController_h
#endif

#import "DSPFilteringTableViewController.h"
#import "DSPObjectExplorer.h"
@class DSPTableViewSection;

NS_ASSUME_NONNULL_BEGIN

/// A class that displays information about an object or class.
///
/// The explorer view controller uses \c DSPObjectExplorer to provide a description
...
@interface DSPObjectExplorerViewController : DSPFilteringTableViewController

/// Uses the default \c DSPShortcutsSection for this object as a custom section.
+ (instancetype)exploringObject:(id)objectOrClass;
/// No custom section unless you provide one.
+ (instancetype)exploringObject:(id)objectOrClass customSection:(nullable DSPTableViewSection *)customSection;
/// No custom sections unless you provide some.
+ (instancetype)exploringObject:(id)objectOrClass
                 customSections:(nullable NSArray<DSPTableViewSection *> *)customSections;
