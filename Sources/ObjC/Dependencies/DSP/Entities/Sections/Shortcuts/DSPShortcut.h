...
/// subset of the responsibilities of a \c DSPShortcutsSection
...
@protocol DSPShortcut <DSPObjectExplorerItem>
...
/// Provides default behavior for DSP metadata objects. Also works in a limited way with strings.
/// Used internally. If you wish to use this object, only pass in \c DSP* metadata objects.
@interface DSPShortcut : NSObject <DSPShortcut>

/// @param item An \c NSString or \c DSP* metadata object.
/// @note You may also pass a \c DSPShortcut conforming object,
...
/// Provides a quick and dirty implementation of the \c DSPShortcut protocol,
/// allowing you to specify a static title and dynamic atttributes for everything else.
/// The object passed into each block is the object passed to each \c DSPShortcut method.
///
/// Does not support the \c -editorWith: method.
@interface DSPActionShortcut : NSObject <DSPShortcut>
