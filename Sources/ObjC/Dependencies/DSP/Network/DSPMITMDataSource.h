...
@interface DSPMITMDataSource<__covariant TransactionType> : NSObject
...
- (void)reloadData:(void (^_Nullable)(DSPMITMDataSource *dataSource))completion;
- (void)filter:(NSString *)searchString completion:(void(^_Nullable)(DSPMITMDataSource *dataSource))completion;
