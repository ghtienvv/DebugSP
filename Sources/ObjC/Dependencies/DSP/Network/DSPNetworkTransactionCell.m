...
NSString * const kDSPNetworkTransactionCellIdentifier = @"kDSPNetworkTransactionCellIdentifier";

@interface DSPNetworkTransactionCell ()
...
@implementation DSPNetworkTransactionCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.nameLabel.font = UIFont.dsp_defaultTableCellFont;
        [self.contentView addSubview:self.nameLabel];

        self.pathLabel = [UILabel new];
        self.pathLabel.font = UIFont.dsp_defaultTableCellFont;
...
- (void)setTransaction:(DSPNetworkTransaction *)transaction {
...
- (void)layoutSubviews {
    ...
    self.nameLabel.textColor = self.transaction.displayAsError ? UIColor.redColor : DSPColor.primaryTextColor;
...
+ (NSString *)reuseID {
    return kDSPNetworkTransactionCellIdentifier;
}
