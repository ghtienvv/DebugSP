...
@interface DSPKBToolbarButton ()
@property (nonatomic      ) NSString *title;
@property (nonatomic, copy) DSPKBToolbarAction buttonPressBlock;
...
@implementation DSPKBToolbarButton

+ (instancetype)buttonWithTitle:(NSString *)title {
    return [[self alloc] initWithTitle:title];
}

+ (instancetype)buttonWithTitle:(NSString *)title action:(DSPKBToolbarAction)eventHandler forControlEvents:(UIControlEvents)controlEvent {
    DSPKBToolbarButton *newButton = [self buttonWithTitle:title];
...
- (id)initWithTitle:(NSString *)title {
    ...
    if (self) {
        ...
        self.layer.dsp_continuousCorners = YES;
...
- (void)addEventHandler:(DSPKBToolbarAction)eventHandler forControlEvents:(UIControlEvents)controlEvent {
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[DSPKBToolbarButton class]]) {
...
@implementation DSPKBToolbarSuggestedButton
