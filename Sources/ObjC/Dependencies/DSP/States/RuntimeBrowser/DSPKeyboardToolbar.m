...
@implementation DSPKeyboardToolbar
...
- (void)addButtons {
    ...
    for (DSPKBToolbarButton *button in self.buttons) {
...
- (void)setButtons:(NSArray<DSPKBToolbarButton *> *)buttons {
