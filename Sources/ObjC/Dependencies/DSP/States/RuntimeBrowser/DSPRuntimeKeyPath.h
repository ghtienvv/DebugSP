...
@interface DSPRuntimeKeyPath : NSObject
...
@property (nonatomic, nullable, readonly) DSPSearchToken *bundleKey;
@property (nonatomic, nullable, readonly) DSPSearchToken *classKey;
@property (nonatomic, nullable, readonly) DSPSearchToken *methodKey;
