...
@interface DSPExplorerToolbarItem : UIButton
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(nullable DSPExplorerToolbarItem *)backupItem;
...
@property (nonatomic, readonly) DSPExplorerToolbarItem *sibling;
...
@property (nonatomic, readonly) DSPExplorerToolbarItem *currentItem;
