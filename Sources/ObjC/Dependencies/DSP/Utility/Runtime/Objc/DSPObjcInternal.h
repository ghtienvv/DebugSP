...
//////////////////////////////////////
NS_INLINE BOOL dsp_isTaggedPointer(const void *ptr)  {
    #if OBJC_HAVE_TAGGED_POINTERS
...
#define DSPPointerIsTaggedPointer(obj) dsp_isTaggedPointer((__bridge void *)obj)

/// Whether the given pointer is a valid, readable address.
BOOL DSPPointerIsReadable(const void * ptr);
