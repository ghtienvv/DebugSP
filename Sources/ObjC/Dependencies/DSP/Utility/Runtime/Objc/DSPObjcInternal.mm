...
////////////////////////////////////////////////
NS_INLINE BOOL dsp_isExtTaggedPointer(const void *ptr)  {
...
BOOL DSPPointerIsReadable(const void *inPtr) {
...
BOOL DSPPointerIsValidObjcObject(const void *ptr) {
    ...
    if (dsp_isTaggedPointer(ptr) || dsp_isExtTaggedPointer(ptr)) {
        return YES;
    }
#endif
    ...
    if (!cls || !DSPPointerIsReadable((__bridge void *)cls)) {
        return NO;
    }
    ...
    if (!metaclass || !DSPPointerIsReadable((__bridge void *)metaclass)) {
        return NO;
    }
