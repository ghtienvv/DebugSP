...
@class DSPIvarBuilder, DSPMethodBase, DSPProperty, DSPProtocol;


#pragma mark DSPClassBuilder
@interface DSPClassBuilder : NSObject
...
- (NSArray<DSPMethodBase *> *)addMethods:(NSArray<DSPMethodBase *> *)methods;
/// @return Any properties that failed to be added.
- (NSArray<DSPProperty *> *)addProperties:(NSArray<DSPProperty *> *)properties;
/// @return Any protocols that failed to be added.
- (NSArray<DSPProtocol *> *)addProtocols:(NSArray<DSPProtocol *> *)protocols;
/// @warning Adding Ivars to existing classes is not supported and will always fail.
- (NSArray<DSPIvarBuilder *> *)addIvars:(NSArray<DSPIvarBuilder *> *)ivars;
...
@interface DSPIvarBuilder : NSObject

/// Consider using the \c DSPIvarBuilderWithNameAndType() macro below. 
...
#define DSPIvarBuilderWithNameAndType(nameString, type) [DSPIvarBuilder \
    name:nameString \
    size:sizeof(type) \
