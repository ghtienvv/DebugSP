...
@interface DSPProtocolBuilder ()
@property (nonatomic) Protocol *workingProtocol;
@property (nonatomic) NSString *name;
@end

@implementation DSPProtocolBuilder
...
- (void)addProperty:(DSPProperty *)property isRequired:(BOOL)isRequired {
