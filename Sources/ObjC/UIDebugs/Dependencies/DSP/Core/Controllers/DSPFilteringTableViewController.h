...
#pragma mark - DSPTableViewFiltering
@protocol DSPTableViewFiltering <DSPSearchResultsUpdating>
...
@property (nonatomic, copy) NSArray<DSPTableViewSection *> *sections;
...
@property (nonatomic, copy) NSArray<DSPTableViewSection *> *allSections;

/// This computed property should filter \c allSections for assignment to \c sections
@property (nonatomic, readonly, copy) NSArray<DSPTableViewSection *> *nonemptySections;
...
#pragma mark - DSPFilteringTableViewController
/// A table view which implements \c UITableView* methods using arrays of
/// \c DSPTableViewSection objects provied by a special delegate.
@interface DSPFilteringTableViewController : DSPTableViewController <DSPTableViewFiltering>
...
@property (nonatomic, weak) id<DSPTableViewFiltering> filterDelegate;
