...
@class DSPScopeCarousel, DSPWindow, DSPTableViewSection;

typedef CGFloat DSPDebounceInterval;
/// No delay, all events delivered
extern CGFloat const kDSPDebounceInstant;
/// Small delay which makes UI seem smoother by avoiding rapid events
extern CGFloat const kDSPDebounceFast;
/// Slower than Fast, faster than ExpensiveIO
extern CGFloat const kDSPDebounceForAsyncSearch;
/// The least frequent, at just over once per second; for I/O or other expensive operations
extern CGFloat const kDSPDebounceForExpensiveIO;

@protocol DSPSearchResultsUpdating <NSObject>
...
@interface DSPTableViewController : UITableViewController <
...
@property (nonatomic) DSPTableView *tableView;

/// If your subclass conforms to \c DSPSearchResultsUpdating
...
@property (nonatomic, weak) id<DSPSearchResultsUpdating> searchDelegate;
...
@property (nonatomic) DSPScopeCarousel *carousel;
...
@property (nonatomic) DSPDebounceInterval searchBarDebounceInterval;
...
@property (nonatomic, weak) id<DSPSearchResultsUpdating> searchResultsUpdater;
