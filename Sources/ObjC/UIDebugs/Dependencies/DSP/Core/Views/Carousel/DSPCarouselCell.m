...
- (void)updateAppearance {
    ...
    if (self.selected) {
        ...
        self.titleLabel.textColor = DSPColor.deemphasizedTextColor;
    }
}
...
- (void)installConstraints {
    ...
    [self.titleLabel dsp_pinEdgesToSuperviewWithInsets:UIEdgeInsetsMake(10, 15, 8 + stripeHeight, 15)];
