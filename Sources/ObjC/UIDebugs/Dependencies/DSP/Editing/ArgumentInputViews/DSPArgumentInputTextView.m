...
@interface DSPArgumentInputTextView ()
...
@implementation DSPArgumentInputTextView
...
- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    ...
    if (self) {
        ...
        self.inputTextView.backgroundColor = DSPColor.secondaryGroupedBackgroundColor;
        ...
        if (@available(iOS 11, *)) {
            ...
            self.inputTextView.layer.borderColor = DSPColor.borderColor.CGColor;
        }

        self.placeholderLabel = [UILabel new];
        self.placeholderLabel.font = self.inputTextView.font;
        self.placeholderLabel.textColor = DSPColor.deemphasizedTextColor;
...
- (NSUInteger)numberOfInputLines {
    switch (self.targetSize) {
        case DSPArgumentInputViewSizeDefault:
            return 2;
        case DSPArgumentInputViewSizeSmall:
            return 1;
        case DSPArgumentInputViewSizeLarge:
            return 8;
    }
}
