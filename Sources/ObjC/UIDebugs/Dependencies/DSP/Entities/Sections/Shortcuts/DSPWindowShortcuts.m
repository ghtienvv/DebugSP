...
@implementation DSPWindowShortcuts

#pragma mark - Overrides

+ (instancetype)forObject:(UIView *)view {
    return [self forObject:view additionalRows:@[
        [DSPActionShortcut title:@"Animation Speed" subtitle:^NSString *(UIWindow *window) {
            ...
            [DSPAlert makeAlert:^(DSPAlert *make) {
                ...
                make.button(@"OK").handler(^(NSArray<NSString *> *strings) {
                    ...
                    [(DSPObjectExplorerViewController *)host reloadData];
                });
