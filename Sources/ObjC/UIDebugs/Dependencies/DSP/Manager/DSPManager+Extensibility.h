...
@interface DSPManager (Extensibility)
...
/// that conflict with DSP, or if you like doing things the hard way ;)
...
/// @note DSP registers several default keyboard shortcuts. Use the '?' key to see a list of shortcuts.
