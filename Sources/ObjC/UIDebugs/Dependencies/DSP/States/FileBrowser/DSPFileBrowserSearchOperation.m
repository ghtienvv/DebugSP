...
@implementation NSMutableArray (DSPStack)

- (void)dsp_push:(id)anObject {
...
@interface DSPFileBrowserSearchOperation ()
...
@implementation DSPFileBrowserSearchOperation
