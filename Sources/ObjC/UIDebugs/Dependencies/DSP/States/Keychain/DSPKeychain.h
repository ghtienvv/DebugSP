...
/// Error code specific to DSPKeychain that can be returned in NSError objects.
/// For codes returned by the operating system, refer to SecBase.h for your
/// platform.
typedef NS_ENUM(OSStatus, DSPKeychainErrorCode) {
    /// Some of the arguments were invalid.
    DSPKeychainErrorBadArguments = -1001,
};

/// DSPKeychain error domain
extern NSString *const kDSPKeychainErrorDomain;

/// Account name.
extern NSString *const kDSPKeychainAccountKey;

/// Time the item was created.
///
/// The value will be a string.
extern NSString *const kDSPKeychainCreatedAtKey;

/// Item class.
extern NSString *const kDSPKeychainClassKey;

/// Item description.
extern NSString *const kDSPKeychainDescriptionKey;

/// Item group.
extern NSString *const kDSPKeychainGroupKey;

/// Item label.
extern NSString *const kDSPKeychainLabelKey;

/// Time the item was last modified.
///
/// The value will be a string.
extern NSString *const kDSPKeychainLastModifiedKey;

/// Where the item was created.
extern NSString *const kDSPKeychainWhereKey;
...
@interface DSPKeychain : NSObject
...
///
/// @note See the `NSString` constants declared in DSPKeychain.h for a list of keys that
