...
#define DSPKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define DSPKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef DSPKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, DSPKeychainQuerySynchronizationMode) {
    DSPKeychainQuerySynchronizationModeAny,
    DSPKeychainQuerySynchronizationModeNo,
    DSPKeychainQuerySynchronizationModeYes
};
#endif

/// Simple interface for querying or modifying keychain items.
@interface DSPKeychainQuery : NSObject
...
@property (nonatomic) DSPKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/// The #define DSPKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time.
