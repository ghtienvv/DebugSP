...
/// always go back and move it to \c DSPMethodBase if we find we need to.
@interface DSPMethod : DSPMethodBase
...
/// Constructs an \c DSPMethod for the given method on the given class.
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c DSPMethod object, or \c nil if the
...
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c DSPMethod object, or \c nil \e if the
...
#define DSPMagicNumber 0xdeadbeef
#define DSPArg(expr) DSPMagicNumber,/// @encode(__typeof__(expr)), (__typeof__(expr) []){ expr }
...
@interface DSPMethod (Comparison)
