...
//        iv.userInteractionEnabled = YES;
    ...
    _track = newSubviewImageView(DSPResources.rangeSliderTrack);
    _fill = newSubviewImageView(DSPResources.rangeSliderFill);
    _leftHandle = newSubviewImageView(DSPResources.rangeSliderLeftHandle);
    _rightHandle = newSubviewImageView(DSPResources.rangeSliderRightHandle);
}
...
- (void)layoutSubviews {
    ...
    self.leftHandle.frame = DSPRectMake(
    ...
    self.rightHandle.frame = DSPRectMake(
